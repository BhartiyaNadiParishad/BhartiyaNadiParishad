...
export default function TeamList({title, data}) {
    return (
        <>
            <Typography variant='h4' fontWeight={"bold"} textAlign={"center"} >{title}</Typography>
            <Grid2 container rowSpacing={8}>
                    {data.map((item, index) => (
                        ...
                        >   
                            ...
                            <Typography variant="h6" textAlign={"center"} fontWeight={"bold"}>{item.name}</Typography>
                            <Typography variant="h6" textAlign={"center"}>{item.title1}</Typography>
                            { item.title2 && <Typography variant="h6" textAlign={"center"}>{item.title2}</Typography>}
                            <Box display={"flex"} columnGap={"8px"}>
                                ...
                                {item.linkedinLink && (
                                    <a target="_blank" href={item.linkedinLink}>
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32" height="32" viewBox="0 0 48 48">
                                ...
                                {item.gmailLink && (
                                    <a target="_blank" href={item.gmailLink}>
