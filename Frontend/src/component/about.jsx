  ...
  return (
    <MainLayout>
      ...
      <Grid container spacing={3} sx={{ padding: "18px 15%" }}>
        ...
        <Grid item xs={12}>
          <ContentSection
            content="In India, the efforts of the society and the government seem to be shared at some places, at some places their coordination seems incomplete and at some places the correct technical knowledge is not available. The BHARTIYA NADI PARISHAD (Bhartiya Nadi Parishad) has been formed to coordinate the efforts of society and government for the rivers of India and to take forward efforts for the rivers in a better way by learning from each other's experiences. We can also know BHARTIYA NADI PARISHAD in English by the name Indian River Council. The main objective of the Bhartiya Nadi Parishad is to coordinate the efforts of society and government for river rejuvenation in India and to achieve positive results from those efforts. We believe that the Bhartiya Nadi Parishad will help in carrying forward river rejuvenation efforts in a coordinated manner in the country. Through the Bhartiya Nadi Parishad, it will also be ensured that by the year 2047, when India completes 100 years of independence, the rivers of India become completely clean and uninterrupted. India's Mission (LiFE) Lifestyle for Environment also has an important contribution in the betterment of rivers. India believes that the entire world is one family, and our future is also shared, in such a situation, the clean and uninterrupted flow of India's rivers through the Bhartiya Nadi Parishad is also helpful in fulfilling the sustainable development goals of the UN.. Every river in India has its own story and specialty."
            backgroundColor=""
            textColor="#375c84"
          />
        </Grid>
        ...
        <Grid item xs={12}>
          <ContentSection
            content="Through the Bhartiya Nadi Parishad, river warriors engaged in river rejuvenation efforts in different states of the country will be able to share their experiences with each other and learn from each other. While the Bhartiya Nadi Parishad will provide technical support to the river warriors, it will also help in reaching the government schemes to the society. Through the Bhartiya Nadi Parishad, river researchers, river experts, policy makers, river lovers and the public will get a better opportunity to understand the entire river system of India. For this, a portal called NADI DARSHAN has been developed by the Bhartiya Nadi Parishad. Through this portal, one can get information about the legends, importance, floods, droughts, pollution, encroachment, dams, policies, and agreements etc. related to the rivers of India and the efforts made by the society and the government for the betterment of those rivers. The efforts being made can also be known."
            textColor="#375c84"
          />
        </Grid>
        <Grid item xs={12}>
