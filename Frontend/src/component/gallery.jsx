...
import img from "../assets/background3.png";
...
export default function Gallery() {
	...
	return (
		<MainLayout title="Gallery" bgImg={bgImg} position={"bottom"}>
			<Box
				sx={{
			...
			>
				<Box
					sx={{
						...
						margin: "auto",
						position: "relative",
						width: `${isMinimized ? "35vw" : "95vw"}`,
						height: `${isMinimized ? "45vh" : "85vh"}`,
						transition:
								...
								/> */}
									...
									<img
										...
										style={{
											cursor: "pointer", // Change cursor to pointer on hover
											transition:
												"width 0.5s ease-in-out", // Smooth transition
											border: "1px solid rgba(255,255,255,0.28)",
											borderRadius: "10px",
										}}
									/>
