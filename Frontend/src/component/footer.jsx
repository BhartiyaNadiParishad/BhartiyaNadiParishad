...
export default function Footer() {
    return (
        <>
            <Grid container pb={2} mx={4} mt={4} justifyContent={'space-between'} rowGap={2} sx={{ color: "rgb(19 100 173)" ,borderBottom: "1px solid grey" }}>
                <Grid xs={12} display={"flex"} justifyContent={"center"} alignItems={"center"} columnGap={2}>
                ...
                <Grid display="flex" flexDirection="column" rowGap={1}>
                    <Typography sx={{ fontWeight: "bold", fontSize: "20px" }}>River Rejuvenation Blueprint</Typography>
                    <Box>
                ...
                <Grid display="flex" flexDirection="column" rowGap={1}>
                    <Typography sx={{ fontWeight: "bold", fontSize: "20px" }}>River Rules, Treaty , Acts <br /> and Guidelines</Typography>
                    <Box>
            ...
            <Grid my={2} container justifyContent={'center'}>
                <Typography sx={{ fontSize: "16px" , color: "rgb(19 100 173)" }}>© Copyright Bhartiya Nadi Parishad. All Rights Reserved</Typography>
            </Grid>
        </>
    )
}
